...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        # store Q-values as a Counter (default 0.0 for unseen keys)
    ...
    def computeActionFromQValues(self, state):
        ...
        # compute best Q-value
        maxQ = self.computeValueFromQValues(state)
        # get all actions with that Q-value
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        """
        "*** YOUR CODE HERE ***"
        # feature vector is a util.Counter (mapping feature name -> value)
    ...
    def update(self, state, action, nextState, reward):
        ...
        for f, val in features.items():
            self.weights[f] += self.alpha * difference * val
